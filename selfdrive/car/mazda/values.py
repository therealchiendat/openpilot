...
FW_VERSIONS = {
  ...
  CAR.Mazda3: {
    ...
    # IC - Instrument Cluster
    (Ecu.combinationMeter, 0x720, None): [
      b'B63E-554K2-A\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00', # 2017/2018
    ],
    # SSU - Start Stop Unit
    (Ecu.ssu, 0x731, None): [
      b'GMS2-675S1-E-05\x00\x00\x00\x00\x00\x00\x00\x00\x00',
      b'GMB6-675S1-A-07\x00\x00\x00\x00\x00\x00\x00\x00\x00',
    ],
    # Air Bag
    (Ecu.srs, 0x737, None): [
      b'BB70532_Cat5_20160308\x00\x00\x00',
